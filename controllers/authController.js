...
const createSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    ...
    // secure: true, only do it in production
    httpOnly: true,
  };
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // check if email and possword exist
  if (!email || !password) {
...
exports.restrictTo = (...roles) => {
  return (req, res, next) => {
    // roles = ['admin', 'lead-guide']; but not 'user'
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  //3. Update changedPasswordAt propery of user
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  // findByIDAndUpdate wouldn't work as intended
